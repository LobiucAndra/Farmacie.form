...
namespace Farmacie
{
    public partial class Form1 : Form
    {
        ...
        private void buttonAdaugaMed_Click(object sender, EventArgs e)
        {
            ...
            {
                labelEroare.Text = "Introduceti numele medicamentului";
                return;
            }
            if(textBoxNumeMedicament.Text.Length>dimensiuneSirMax)
            {
                labelEroare.Text = "Numele medicamentului este prea lung";
                return;
            }
            nume = textBoxNumeMedicament.Text;
            if(!int.TryParse(textBoxAgaudaCantitate.Text,out cantitate))
            {
                labelEroare.Text = "Introduceti cantitatea medicamentului";
                return;
            }
            ...
            {
                labelEroare.Text = "Alegeti categoria varstei, va rog!";
                return;
            }
            ...
            labelEroare.Text = "Felicitari! Medicamentul a fost adaugat cu succes.";
            curataEcran();
            return;
